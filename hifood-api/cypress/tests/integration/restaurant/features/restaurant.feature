Feature: State endpoint tests
  ...
  Scenario: GET to /restaurants should return all restaurants
    Given I hit "GET" to endpoint "/restaurants"
    Then should return all "restaurant"
    And should return status code "200"

  Scenario: GET to /restaurants/{id} should return specific restaurant existent in database
